...
+
https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html["BlueXPのコピーと同期サービスの詳細については、こちらをご覧ください"^]。
...
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-scanning-s3.html["BlueXP分類サービスの詳細については、こちらをご覧ください"^]。
